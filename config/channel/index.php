...
?>
      ...
      <div id="page-wrapper">
              <div class="panel-body">
                <div class="row">
                  <div class="col-lg-12">
                    <h1>Report Channel <small>Maintenance Page</small></h1>
                    <ol class="breadcrumb">
                      <li ><a href="../../config"><i class="icon-cogs"></i> Configuration</a></li>
                      <li class="active"><i class="icon-link"></i> Report Channel</li>
                    </ol>
                  </div>
                </div><!-- /.row -->
...
$query = "SELECT COUNT(*) as num FROM code_definition where code_cat='casevia'";
...
<!--         <td>
          <font face="Arial" size="1">
            <a href="javascript:updatecaseVia('<?=$id?>','<?=$code_cat?>','<?=$code?>','<?=$code_name?>','<?=$descr?>')" >
              <span style="cursor: pointer; cursor: hand;" class="ui-icon ui-icon-pencil"></span>
            </a>
            <a href="javascript:deletecaseVia('<?=$id?>')">
