...
$begin	    		= "2022-01-01";//mysqli_real_escape_string($con,htmlspecialchars(trim($_GET['begin'])));       // begin date
$end	    		= "2022-12-31";//mysqli_real_escape_string($con,htmlspecialchars(trim($_GET['end'])));         // end date
