...
?>
          ...
          <div class="col-lg-12">
            <div class="page-title">
              <ol class="breadcrumb_date">
                ...
                <div class="table-responsive" id="div_app_list" style="">              
                </div>
            </div>
      </div><!-- /#page-wrapper -->
    ...
    $('select#inventory_client').load('../lookup/client_filter.php?selected='+$('#client').val()+'&code=4096', function() {  })    
    $('select#inventory_project').load('../lookup/project_filter.php?client='+$('#inventory_client').val()+'&selected='+$('#project').val()+'&code=4096', function() { 
...
$('#apply_filter').click(function(){
  ...
  if(client !=""){
    ...
    var fltr = fltr + " project_code = ^"+ project+"^";
  }
